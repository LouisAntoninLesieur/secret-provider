...
import { InputField } from './GeneratorForm/InputField';
import { GenerateButton } from './GeneratorForm/GenerateButton';
import { CopyButton } from './GeneratorForm/CopyButton';
import { SecretDisplay } from './GeneratorForm/SecretDisplay';
import { generateSecret } from '../utils/secrets/generateRandomHex';
import { IndependentDisplay } from './GeneratorForm/IndependentDisplay';
...
export const GeneratorForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col w-screen items-center gap-2'>
      <InputField values={values} onChange={handleChange} />
      <GenerateButton />
